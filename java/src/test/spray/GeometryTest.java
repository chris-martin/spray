...
public class GeometryTest {
  ...
  @Test public void testVecDot2() { assertApprox(xy(2, 6).dot(origin2()), 0); }
  ...
  @Test public void testLineSide3() { assertEquals(oTo2(xy(0, -1)).side(xy(1, 1)), LEFT); }
  @Test public void testLineSide4() { assertEquals(oTo2(xy(0, -1)).side(xy(-1, 1)), RIGHT); }
  @Test public void testLineSide5() { assertEquals(oTo2(xy(1, 1)).side(xy(1, 0)), RIGHT); }
  @Test public void testLineSide6() { assertEquals(oTo2(xy(1, 1)).side(xy(0, 1)), LEFT); }
  ...
  @Test public void testBulge1() { Line2 l = aToB(xy(0, 0), xy(1, 0));
    assertLess(l.bulge(xy(.5, .1)), l.bulge(xy(.5, .2))); }
  @Test public void testBulge2() { Line2 l = aToB(xy(0, 0), xy(1, 0));
    assertLess(l.bulge(xy(.5, -.1)), l.bulge(xy(.5, -.2))); }
  @Test public void testBulge3() { Line2 l = aToB(xy(0, 0), xy(1, 0));
    assertLess(l.bulge(xy(.5, .1)), l.bulge(xy(.5, 20))); }
  @Test public void testBulge4() { Line2 l = aToB(xy(0, 0), xy(1, 0));
    assertLess(l.bulge(xy(.5, 10)), l.bulge(xy(.5, 20))); }
  @Test public void testBulge5() { Line2 l = aToB(xy(660, 28), xy(707, 113));
