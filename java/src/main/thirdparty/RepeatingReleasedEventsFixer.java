...
public class RepeatingReleasedEventsFixer implements AWTEventListener {
    ...
    public static RepeatingReleasedEventsFixer getInstance() {
        if (INSTANCE == null) {
    ...
    public static void install() {
        Toolkit.getDefaultToolkit().addAWTEventListener(getInstance(), AWTEvent.KEY_EVENT_MASK);
    }

    public static void remove() {
        Toolkit.getDefaultToolkit().removeAWTEventListener(getInstance());
    }
